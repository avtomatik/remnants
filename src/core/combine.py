...
from core.funcs import (enlist_series_ids, pull_by_series_id, read_source,
...
def combine_usa_xlsm() -> pd.DataFrame:
    ...
    return pd.concat(
        [
            ...
            pd.read_csv(DATA_DIR / FILE_NAME, index_col=0),
        ],
        axis=1,
    )
...
def combine_combined_archived() -> pd.DataFrame:
    ...
    SERIES_IDS_SFAT = [SeriesID("k1n31gd1es00", URL.FIAS)] + [
        # =====================================================================
