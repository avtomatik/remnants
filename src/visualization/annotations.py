...
def main():
    ...
    # Option 1: 1967--2012
    # =========================================================================
    pd.concat([df["cap_0x0"], L, df["prd_0x0"]], axis=1).pipe(
        transform_add_dx_dy
    )
    # =========================================================================
    # Option 2: 1967--2012
    # =========================================================================
    pd.concat([df["cap_0x0"], L, df["prd_0x1"]], axis=1).pipe(
        transform_add_dx_dy
    )
    # =========================================================================
    # Option 3: 1967--2012
    # =========================================================================
    pd.concat([df["cap_0x3"], L, df["prd_0x0"]], axis=1).pipe(
        transform_add_dx_dy
    )
    # =========================================================================
    # Option 4: 1967--2012
    # =========================================================================
    pd.concat([df["cap_0x3"], L, df["prd_0x1"]], axis=1).pipe(
        transform_add_dx_dy
    )
    # =========================================================================
