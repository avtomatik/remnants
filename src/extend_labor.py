...
def get_data_frame():
    ...
    return pd.concat(
        [
            ...
            pd.read_csv(DATA_DIR / FILE_NAME, index_col=0).iloc[:, [1]],
        ],
        axis=1,
    )
...
if __name__ == "__main__":
    ...
    df_left = (
        stockpile(SERIES_ID).mul(df_right.at[YEAR_BASE, COL_NAME]).div(100)
    )
    ...
    LABEL = ["C.W. Cobb, P.H. Douglas Labor Series", "labor_combined"]
